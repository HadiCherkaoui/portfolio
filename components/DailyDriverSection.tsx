...
export default function DailyDriverSection() {
  const { ref: imageRef, spotlightProps: imageSpotlight } = useSpotlight<HTMLDivElement>();
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-headline text-4xl md:text-5xl lg:text-6xl mb-6">
            My{" "}
            <span className="emerald-accent">Daily Driver</span>
          </h2>
              ...
              <div className="relative h-[400px] rounded-xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6">
                  <div className="flex items-center gap-3 mb-2">
                    <svg
                      className="w-8 h-8 text-[var(--accent-emerald)]"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
                  ...
                  <p className="text-white/90 text-sm">
                    Customized Arch Linux desktop environment with KDE Plasma
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="md:w-1/2 order-1 md:order-2">
            <div className="space-y-4 text-[var(--text-secondary)]">
              <p className="text-lg leading-relaxed">
                I made the decision to migrate from Windows to{" "}
                <span className="font-medium text-[var(--accent-emerald)]"
                >
                  Arch Linux
                </span>{" "}
                as my daily operating system. This transition represents my
                commitment to open-source software, customization, and learning
                the inner workings of my system.
              </p>

              <p className="text-lg leading-relaxed">
                Arch Linux offers me complete control over my computing
                environment, allowing me to build a minimal, efficient system
                tailored to my specific needs. The rolling release model ensures
                I&apos;m always running the latest software without major version
                upgrades.
              </p>

              <p className="text-lg leading-relaxed">
                The journey wasn&apos;t without challenges, but the process taught me
                valuable skills in system administration, troubleshooting, and
                the Linux ecosystem. Now I enjoy a lightweight, secure, and
                highly customized desktop that perfectly suits my workflow.
              </p>
            </div>
