    ...
    <footer className="py-12 px-4 relative overflow-hidden border-t border-[var(--border-subtle)]">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          {/* Brand */}
          <div>
            <h3 className="font-headline text-xl mb-4 text-[var(--accent-emerald)]">
              Hadi Cherkaoui
            </h3>
        ...
        {/* Copyright */}
        <div className="pt-8 mt-8 border-t border-[var(--border-subtle)] text-center">
          <p className="text-[var(--text-muted)]">
            &copy; {new Date().getFullYear()} Hadi Cherkaoui - All rights
            reserved
          </p>
        </div>
      </div>
