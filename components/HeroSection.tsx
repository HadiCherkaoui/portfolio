      ...
      <div className="container mx-auto max-w-4xl relative z-10 text-center">
        ...
        <div className="mt-12 flex justify-center space-x-6">
          ...
          <a href="https://gitlab.cherkaoui.ch/HadiCherkaoui" target="_blank" rel="noopener noreferrer" className="text-[var(--foreground)]/70 hover:text-[var(--primary-color)] transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0L8.5 9.5h7L12 0zM1.5 9.5L12 24l-7-4.5L1.5 9.5zM22.5 9.5L19 19.5 12 24l10.5-14.5zM8.5 9.5L5 19.5 12 24 8.5 9.5zM15.5 9.5L19 19.5 12 24l3.5-14.5z"/></svg>
          </a>
